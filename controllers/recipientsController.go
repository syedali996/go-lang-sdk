...
func (r *RecipientsController) UpdateRecipient(
    ...
    if err != nil {
        return https.ApiResponse[models.GetRecipientResponse]{}, err
    }
...
func (r *RecipientsController) CreateAnticipation(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.GetAnticipationResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.GetAnticipationResponse]{}, err
...
func (r *RecipientsController) GetAnticipationLimits(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.GetAnticipationLimitResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.GetAnticipationLimitResponse]{}, err
...
func (r *RecipientsController) GetRecipients(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.ListRecipientResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.ListRecipientResponse]{}, err
...
func (r *RecipientsController) GetWithdrawById(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.GetWithdrawResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.GetWithdrawResponse]{}, err
...
func (r *RecipientsController) GetTransfers(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.ListTransferResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.ListTransferResponse]{}, err
...
func (r *RecipientsController) GetTransfer(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.GetTransferResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.GetTransferResponse]{}, err
...
func (r *RecipientsController) GetAnticipations(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.ListAnticipationResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.ListAnticipationResponse]{}, err
...
func (r *RecipientsController) GetBalance(recipientId string) (
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.GetBalanceResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.GetBalanceResponse]{}, err
...
func (r *RecipientsController) GetWithdrawals(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.ListWithdrawals]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.ListWithdrawals]{}, err
