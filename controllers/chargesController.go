...
func (c *ChargesController) UpdateChargeMetadata(
    ...
    if err != nil {
        return https.ApiResponse[models.GetChargeResponse]{}, err
    }
...
func (c *ChargesController) GetChargeTransactions(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.ListChargeTransactionsResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.ListChargeTransactionsResponse]{}, err
...
func (c *ChargesController) GetCharges(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.ListChargesResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.ListChargesResponse]{}, err
...
func (c *ChargesController) GetChargesSummary(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.GetChargesSummaryResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.GetChargesSummaryResponse]{}, err
