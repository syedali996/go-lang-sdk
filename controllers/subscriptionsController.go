...
func (s *SubscriptionsController) RenewSubscription(
    ...
    if err != nil {
        return https.ApiResponse[models.GetPeriodResponse]{}, err
    }
...
func (s *SubscriptionsController) UpdateSubscriptionCard(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.GetSubscriptionResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.GetSubscriptionResponse]{}, err
...
func (s *SubscriptionsController) DeleteUsage(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.GetUsageResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.GetUsageResponse]{}, err
...
func (s *SubscriptionsController) CreateDiscount(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.GetDiscountResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.GetDiscountResponse]{}, err
...
func (s *SubscriptionsController) GetSubscriptionItems(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.ListSubscriptionItemsResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.ListSubscriptionItemsResponse]{}, err
...
func (s *SubscriptionsController) GetSubscriptionItem(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.GetSubscriptionItemResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.GetSubscriptionItemResponse]{}, err
...
func (s *SubscriptionsController) GetSubscriptions(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.ListSubscriptionsResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.ListSubscriptionsResponse]{}, err
...
func (s *SubscriptionsController) CreateIncrement(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.GetIncrementResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.GetIncrementResponse]{}, err
...
func (s *SubscriptionsController) GetSubscriptionCycles(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.ListCyclesResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.ListCyclesResponse]{}, err
...
func (s *SubscriptionsController) GetDiscounts(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.ListDiscountsResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.ListDiscountsResponse]{}, err
...
func (s *SubscriptionsController) GetIncrements(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.ListIncrementsResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.ListIncrementsResponse]{}, err
...
func (s *SubscriptionsController) GetUsages(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.ListUsagesResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.ListUsagesResponse]{}, err
...
func (s *SubscriptionsController) GetUsageReport(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.GetUsageReportResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.GetUsageReportResponse]{}, err
