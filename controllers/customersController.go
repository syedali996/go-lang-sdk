...
func (c *CustomersController) UpdateCard(
    ...
    if err != nil {
        return https.ApiResponse[models.GetCardResponse]{}, err
    }
...
func (c *CustomersController) UpdateAddress(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.GetAddressResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.GetAddressResponse]{}, err
...
func (c *CustomersController) DeleteAccessToken(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.GetAccessTokenResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.GetAccessTokenResponse]{}, err
...
func (c *CustomersController) CreateCustomer(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.GetCustomerResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.GetCustomerResponse]{}, err
...
func (c *CustomersController) DeleteAccessTokens(customerId string) (
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.ListAccessTokensResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.ListAccessTokensResponse]{}, err
...
func (c *CustomersController) GetCustomers(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.ListCustomersResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.ListCustomersResponse]{}, err
...
func (c *CustomersController) GetCards(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.ListCardsResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.ListCardsResponse]{}, err
...
func (c *CustomersController) GetAddresses(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.ListAddressesResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.ListAddressesResponse]{}, err
