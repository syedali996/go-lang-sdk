...
func (o *OrdersController) GetOrders(
    ...
    if err != nil {
        return https.ApiResponse[models.ListOrderResponse]{}, err
    }
...
func (o *OrdersController) UpdateOrderItem(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.GetOrderItemResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.GetOrderItemResponse]{}, err
...
func (o *OrdersController) DeleteAllOrderItems(
    ...
    decoder, resp, err := req.CallAsJson()
    if err != nil {
        return https.ApiResponse[models.GetOrderResponse]{}, err
    }
    err = validateResponse(*resp)
    if err != nil {
        return https.ApiResponse[models.GetOrderResponse]{}, err
